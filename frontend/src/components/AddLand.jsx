...
const LandPurchaseForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await addLand (formData);
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        <div className="row g-3">
          ...
          <div className="col-md-12">
            ...
            <input type="file" name="documents" multiple className="form-control" onChange={handleFileChange} />
          </div>

        </div>

        <div className="m-4 text-center">
          <button type="submit" className="btn btn-primary">Post Land</button>
        </div>
      </form>
    </div>
    </MainLayout>
